...
import { follow, ignore, setCurrentPage, getUsers } from '../../redux/users-reducer';
...
export default compose(withAuthRedirect,connect(mapStateToProps, { follow, ignore, setCurrentPage, getUsers }))(UsersContainerAPI)
